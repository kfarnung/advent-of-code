...
std::vector<std::string> pick_winners(const std::vector<Reindeer> &input,
...
int32_t day14::find_longest_distance(const std::vector<std::string> &input,
                                     int32_t target_time) {
...
int32_t day14::find_part2_winner(const std::vector<std::string> &input,
                                 int32_t target_time) {
  auto reindeer_list = parse_list(input);
