...
std::tuple<std::vector<int64_t>, std::vector<BingoBoard>>
parse_input(const std::vector<std::string> &input) {
  ...
  return std::tuple<std::vector<int64_t>, std::vector<BingoBoard>>{numbers,
                                                                   boards};
}
...
int64_t score_board(BingoBoard board, std::set<int64_t> chosen_numbers,
                    int64_t last_number) {
  int64_t score = 0;
