...
class Day15 {
  ...
  static countMatches (startingValueA, startingValueB, numIterations, requiredMultipleA = 1, requiredMultipleB = 1) {
    const generatorA = this.generateValues(startingValueA, 16807, requiredMultipleA)
    const generatorB = this.generateValues(startingValueB, 48271, requiredMultipleB)
